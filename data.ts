...
// Types for command types
const AUDIO = "AUDIO";
const TEXT = "TEXT";

// Guilds array with guild names and IDs
const guilds: { name: string; id: string }[] = [
    { name: "Wanna", id: "233725944911626240" },
    { name: "Bytes", id: "185183293552066560" },
    { name: "plll", id: "243582757815451649" },
];

// Guilds object for easier access
const G_: Record<string, { id: string }> = {
    Wanna: { id: "233725944911626240" },
    Bytes: { id: "185183293552066560" },
    Test: { id: "243582757815451649" },
};

// Users array with usernames and IDs
const users: { username: string; id: string }[] = [
    { username: LEOG, id: "158794899083231232" },
    { username: GD92, id: "220352903578124288" },
    { username: MAVE, id: "311259706133839873" },
    { username: PABLOC, id: "323306470022053898" },
    { username: ANDY, id: "236909116474261505" },
    { username: DREVI, id: "233728781167230996" },
    { username: TINCHO, id: "158805057775599625" },
    { username: EZEQ, id: "158793676116590593" },
];

// Users object for easier access to user data
export const U_: Record<string, { id: string; nick: string }> = {
    LEOG: { id: "158794899083231232", nick: "leog" },
    GAROLFA: { id: "idSarasa", nick: "garolfa" },
};

// Commands object with command definitions
export const C_: Record<
    string,
    { name: string; type: string; description: string; permission?: { id: string }[] }
> = {
...
// Function to pick an emoji (to be implemented)
const pickEmoji = (): void => { };

// Utility functions to check guild IDs
export const isBytes = (c_id: string): boolean =>
    guilds.find((g) => g.name === "Bytes")?.id === c_id;

export const isWanna = (c_id: string): boolean =>
    guilds.find((g) => g.name === "Wanna")?.id === c_id;

export const isTestGuild = (c_id: string): boolean =>
    guilds.find((g) => g.name === "plll")?.id === c_id;

// Function to find a user by username
export const findUser = (userName: string): { username: string; id: string } | undefined =>
